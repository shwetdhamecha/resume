        ...
        <div class="pt-12 md:py-12 px-2 sm:px-5 md:px-10 lg:px-14">
            ...
            <div class="lg:hidden">
                <div
                    ...
                    <div class="pt-[100px] pb-8">
                        <h2 class="mt-6 mb-1 text-[26px] font-semibold dark:text-white"> Monalisa Ashleys
                        </h2>
                        <h3
            ...
            <div class="lg:grid grid-cols-12 md:gap-10 pt-4 md:pt-[30px] items-center hidden">
                <div class="col-span-12 space-y-2.5">
                    <div class="lg:mr-16">
                        <p class="text-[#44566c] dark:text-color-910 leading-7"> A design graduate is specializing in web design and development. Skilled in essential web designing tools like
JavaScript, HTML, CSS, Ruby and Invision Studio. Also possess hands-on training with designing applications,
including Photoshop and InDesign, through 2.5 years of experience. Eager to get practical experience and develop
leadership skills in a Silicon Valley tech startup. </p>
                        <p class="text-[#44566c] leading-7 mt-2.5 dark:text-color-910"> As a web designer, my objective is to make a positive impact on clients, co-workers, and the Internet using my
skills and experience to design compelling and attractive websites.</p>
                    </div>
                    <div></div>
                </div>
            </div>
        ...
        <div class="px-2 sm:px-5 md:px-10 lg:px-14">
            <div class="bg-[#F8FBFB] dark:bg-[#0D0D0D] max-w-full h-auto py-10 rounded-xl">
                <h3 class="text-center dark:text-white text-6xl mb-3 font-semibold"> What I do! </h3>
                ...
                <div class="slickOne text-center px-2 pt-8">
                    ...
                    <div class="about-box bg-[#fefaf0] dark:bg-transparent">
                        ...
                        <div class="space-y-2">
                            <h3 class="dark:text-white text-[22px] font-semibold"> Figma To HTML </h3>
                            <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]"> Lorem ipsum dolor sit
                                amet, consectetuer adipiscing elit, sed diam euismod volutpat. </p>
                        </div>
                    </div>
                    <div class="about-box bg-[#fcf4ff] dark:bg-transparent">
                        ...
                        <div class="space-y-2">
                            <h3 class="dark:text-white text-[22px] font-semibold"> PSD To HTML </h3>
                            <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]"> Lorem ipsum dolor sit
                                amet, consectetuer adipiscing elit, sed diam euismod volutpat. </p>
                        </div>
                    </div>
